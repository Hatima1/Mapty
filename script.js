...
class app {
  ...
  _getposition(){
    navigator.geolocation.getCurrentPosition( this._lodmap.bind(this)
    ,function(){
        alert("lol man")
  ...
  _lodmap(position){
      ...
      //   console.log(position,latitude,longitude);
        const coords=[14.393082,33.5392081]
  ...
  _newworkout(e){
    ...
    if(type==="running"){
        ...
        if(!valid(Distance,duration,cadence)||!positive(Distance,duration,cadence))return alert("not a number :(")
    ...
    if(type==="cycling"){
        ...
        if(!valid(Distance,duration,elevation)||!positive(Distance,duration,elevation))return alert("not a number :(")
